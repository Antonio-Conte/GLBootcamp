...
public class CustomerController {
	...
	@PostMapping
	public ResponseEntity<CustomerDTO> addCustomer(@RequestBody final CustomerDTO customer)
	{
	...
	public ResponseEntity<CustomerDTO> updateStatus(@RequestParam String status, @PathVariable(name = "id") Integer id)
	{
